        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaldoInicial = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    SaldoFinalEmDinheiro = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    SaldoFinalEmCartoes = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abertura = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nome = table.Column<string>(type: "TEXT", nullable: false),
                    Valor = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    IsImprimir = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Horas = table.Column<DateTime>(type: "TEXT", nullable: false),
                    HoraRemovida = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
